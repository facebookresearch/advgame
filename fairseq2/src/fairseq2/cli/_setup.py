...
def _register_clm_cli(cli: Cli) -> None:
    ...
    # Online Finetune Game
    online_finetune_game_handler = RecipeCommandHandler(
        loader=load_online_finetuner_game,
        config_kls=OnlineFinetuneGameConfig,
        default_preset="llama3_1_instruct_online_dpo_game",
    )

    group.add_command(
        name="online_finetune_game",
        handler=online_finetune_game_handler,
        help="online-finetune-game a language model.",
    )
