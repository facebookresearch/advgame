    ...
    def validate(self) -> None:
        ...
        if result.has_error:
            raise ValidationError(
                "The model configuration section has one or more validation errors:",
                result,  # fmt: skip
            )
...
class DatasetSection:
    ...
    def validate(self) -> None:
        ...
        if result.has_error:
            raise ValidationError(
                "The dataset configuration section has one or more validation errors:",
                result,  # fmt: skip
            )
...
class TrainerSection:
    ...
    def validate(self) -> None:
        ...
        if result.has_error:
            raise ValidationError(
                "The trainer configuration section has one or more validation errors:",
                result,  # fmt: skip
            )
...
class RegimeSection:
    ...
    """If ``True``, checkpointing will save the current trained models."""

    checkpoint_ema_models: bool = True
    """If ``True``, checkpointing will save the current ema model."""

    checkpoint_ref_models: bool = False
    """If ``True``, checkpointing will save the current reference model."""
