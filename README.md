...
Assuming the compute resources are allocated following instructions in the [Models](#models) section and models are copied under /scratch folder, run the training script:
```
